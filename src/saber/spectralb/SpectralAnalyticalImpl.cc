...
auto createSpectralFilter(const oops::GeometryData & geometryData,
                          const SpectralAnalyticalImplParameters & params,
                          const bool & sqrtMode) {
...
SpectralAnalyticalImpl::SpectralAnalyticalImpl(const oops::GeometryData & geometryData,
  ...
  : params_(params),
    ...
    spectralFilter_(createSpectralFilter(geometryData, params, sqrtMode))
{
  oops::Log::trace() << classname() << "::SpectralAnalyticalImpl starting " << std::endl;
  ...
  oops::Log::trace() << classname() << "::SpectralAnalyticalImpl done" << std::endl;
}

// -----------------------------------------------------------------------------

void SpectralAnalyticalImpl::multiply(oops::FieldSet3D & fieldSet) const {
...
void SpectralAnalyticalImpl::multiplyAD(oops::FieldSet3D & fieldSet) const {
...
void SpectralAnalyticalImpl::leftInverseMultiply(oops::FieldSet3D & fieldSet) const {
...
oops::FieldSet3D SpectralAnalyticalImpl::generateInnerFieldSet(
...
oops::FieldSet3D SpectralAnalyticalImpl::generateOuterFieldSet(
...
void SpectralAnalyticalImpl::print(std::ostream & os) const {
  os << classname();
}
