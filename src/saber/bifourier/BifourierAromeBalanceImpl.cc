...
BifourierAromeBalanceImpl::BifourierAromeBalanceImpl(const oops::GeometryData & outerGeometryData,
                                                     const oops::Variables & outerVars,
                                                     const eckit::Configuration & covarConfig,
                                                     const Parameters_ & params,
                                                     const oops::FieldSet3D & xb,
                                                     const oops::FieldSet3D & fg)
  : BifourierBalanceImpl(outerGeometryData, aromeInnerVars(outerVars), covarConfig, params, xb, fg),
    params_(params)
{
  oops::Log::trace() << classname() << "::BifourierAromeBalanceImpl starting" << std::endl;
  ...
  oops::Log::trace() << classname() << "::BifourierAromeBalanceImpl done" << std::endl;
}

// -----------------------------------------------------------------------------

void BifourierAromeBalanceImpl::multiply(oops::FieldSet3D & fset) const {
  ...
  // Generic balance
  BifourierBalanceImpl::multiply(fset);
...
void BifourierAromeBalanceImpl::multiplyAD(oops::FieldSet3D & fset) const {
  ...
  BifourierBalanceImpl::multiplyAD(fset);
...
void BifourierAromeBalanceImpl::leftInverseMultiply(oops::FieldSet3D & fset) const {
  ...
  BifourierBalanceImpl::leftInverseMultiply(fset);
...
void BifourierAromeBalanceImpl::read() {
...
void BifourierAromeBalanceImpl::directCalibration(const oops::FieldSets & fsetEns) {
  ...
  // Generic balance
  BifourierBalanceImpl::directCalibration(fsetEnsCopy);
...
void BifourierAromeBalanceImpl::iterativeCalibrationUpdate(const oops::FieldSet3D & fset) {
  ...
  // Generic balance
  BifourierBalanceImpl::iterativeCalibrationUpdate(fsetCopy);
...
void BifourierAromeBalanceImpl::write() const {
...
oops::Variables BifourierAromeBalanceImpl::aromeInnerVars(const oops::Variables & outerVars) {
  oops::Log::trace() << classname() << "::aromeInnerVars starting" << std::endl;
  ...
  oops::Log::trace() << classname() << "::aromeInnerVars done" << std::endl;
  return vars;
}

// -----------------------------------------------------------------------------

void BifourierAromeBalanceImpl::vorToPb(oops::FieldSet3D & fset) const {
...
void BifourierAromeBalanceImpl::vorToPbAD(oops::FieldSet3D & fset) const {
...
void BifourierAromeBalanceImpl::vorToPbLeftInverse(oops::FieldSet3D & fset) const {
...
void BifourierAromeBalanceImpl::removePb(oops::FieldSet3D & fset) const {
...
void BifourierAromeBalanceImpl::removePbAD(oops::FieldSet3D & fset) const {
...
void BifourierAromeBalanceImpl::removePbLeftInverse(oops::FieldSet3D & fset) const {
...
void BifourierAromeBalanceImpl::splitTPs(oops::FieldSet3D & fset) const {
...
void BifourierAromeBalanceImpl::gatherTPs(oops::FieldSet3D & fset) const {
