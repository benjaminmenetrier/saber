...
BifourierBalanceImpl::BifourierBalanceImpl(const oops::GeometryData & outerGeometryData,
...
{
  oops::Log::trace() << classname() << "::BifourierBalanceImpl starting" << std::endl;
  ...
  oops::Log::trace() << classname() << "::BifourierBalanceImpl done" << std::endl;
}

// -----------------------------------------------------------------------------

void BifourierBalanceImpl::multiply(oops::FieldSet3D & fset) const {
...
void BifourierBalanceImpl::multiplyAD(oops::FieldSet3D & fset) const {
...
void BifourierBalanceImpl::leftInverseMultiply(oops::FieldSet3D & fset) const {
...
void BifourierBalanceImpl::read() {
...
void BifourierBalanceImpl::directCalibration(const oops::FieldSets & fsetEns) {
...
void BifourierBalanceImpl::iterativeCalibrationInit() {
...
void BifourierBalanceImpl::iterativeCalibrationUpdate(const oops::FieldSet3D & fset) {
...
void BifourierBalanceImpl::iterativeCalibrationFinal() {
...
void BifourierBalanceImpl::write() const {
...
void BifourierBalanceImpl::readCovariance() {
...
void BifourierBalanceImpl::computeRegression(const std::vector<std::string> & inputVars,
...
void BifourierBalanceImpl::computeRegressionsFromCovariances() {
...
oops::Variables BifourierBalanceImpl::xxCovVars(const oops::Variable & outputVar) const {
...
void BifourierBalanceImpl::print(std::ostream & os) const {
  // Print norms
